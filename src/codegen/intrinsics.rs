...
#[inline(never)]
pub(crate) unsafe extern "sysv64" fn load_var_intmap(rt: *mut c_void, var: usize) -> *mut c_void {
    let runtime = &mut *(rt as *mut Runtime);
    if let Ok(var) = Variable::try_from(var) {
...
#[inline(never)]
pub(crate) unsafe extern "sysv64" fn store_var_intmap(
    rt: *mut c_void,
    var: usize,
    map: *mut c_void,
) {
...
#[inline(never)]
pub(crate) unsafe extern "sysv64" fn load_var_strmap(rt: *mut c_void, var: usize) -> *mut c_void {
    let runtime = &mut *(rt as *mut Runtime);
    if let Ok(var) = Variable::try_from(var) {
...
#[inline(never)]
pub(crate) unsafe extern "sysv64" fn store_var_strmap(
    rt: *mut c_void,
    var: usize,
    map: *mut c_void,
) {
